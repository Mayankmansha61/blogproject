...
urlpatterns = [path('contact/submit',contact_submit,name='contact_submit'),
               ...
               path('dj-admin/partners',partner_list),
               ...
               path('dj-admin/products',product_list),
               ...
               path('dj-admin/sliders',slider_list),
               ...
               path('dj-admin/homeservices',homeservice_list),
